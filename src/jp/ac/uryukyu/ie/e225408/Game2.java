...
public class Game2 {
     ...
     */    
    public Game2(GamePlayer player, BotBot bot) {
        this.player1 = player;
        this.bot1 = bot;
    ...
    public void startGame() {
        ...
        System.out.println("Player's hand is :" + Hand.evaluateHand(player1, game));
        System.out.println("Bot's hand is :" + Hand.evaluateHand(bot1, game) + "\n");
